 ...
 */
@WebServlet(name = "QuizResult", urlPatterns = {"/quiz-result"})
public class QuizResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int index = 0; index < Repository.questions.size(); index++) {
            try {
                int answerIndex = Integer.parseInt(request.getParameter(String.valueOf(index)));
                Answer selectedAnswer = Repository.questions.get(index).getAnswers().get(answerIndex);
                score += selectedAnswer.getValue();
            } catch (NumberFormatException e) {
                System.out.println(e.getMessage());
            }
        }

        String hero = HeroService.getHeroByScore(score);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<div class=\"container result\">");
            out.println("<h1 class=\"text-center\">" + hero + "</h1>");
            out.println("<a class=\"btn btn-info\" href=\"/quiz\">Refazer o teste</a>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
        }
